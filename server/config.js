...
module.exports = {
  ...
  forge: {
    ...
    callbackURL: process.env.FORGE_CALLBACK_URL || 'https://localhost:5000/api/forge/callback/oauth',
    // credentials
    credentials: {
  ...
  storage: {
    ...
    name: process.env.STORAGE_NAME || "Google",
    needsAccountName: process.env.STORAGE_NEEDS_ACCOUNT_NAME || false,
    callbackURL: process.env.STORAGE_CALLBACK_URL || 'https://localhost:5000/api/' + process.env.STORAGE_NAME + '/callback/oauth',
    credentials: {
  ...
  transfer : {
    endpoint: process.env.TRANSFER_ENDPOINT || 'https://localhost:5000/api/lambda/transfer',
    authorization: process.env.TRANSFER_ENDPOINT_AUTHORIZATION || '',
    callbackURL : process.env.TRANSFER_CALLBACK_URL || 'https://localhost:5000/api/app/callback/transferStatus'
  },
